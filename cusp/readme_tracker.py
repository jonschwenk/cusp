...
def render_tracker(tracker: ReleaseTracker) -> str:
    ...
    return (
        ...
        "| --- | ---: |\n"
        f"| Latest dataset version | [{tracker.version}]({release_url}) |\n"
        f"| Total observations | {tracker.total_observations:,} |\n"
        f"| Permafrost presence observations | {tracker.presence_observations:,} |\n"
        f"| Permafrost absence observations | {tracker.absence_observations:,} |\n"
        f"| ALT / thaw-depth measurements | {tracker.alt_observations:,} |\n"
        f"| Included sources | {tracker.source_count:,} |\n\n"
